  ...
  return (
    <App>
      <div className="flex flex-col justify-center items-center h-screen bg-gray-100">
        <div className="flex flex-col justify-center items-center bg-white w-96 h-auto rounded-2xl">
          <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4 mt-4">
            Oops!
          </h1>
